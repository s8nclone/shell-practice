...
/**
 * help_all - Displays all possible builtin simple_shell commands.
 */
void help_all(void)
{
	char *msg = "simple_hell\nThese shell commands are defined internally.\n";
...
/**
 * help_alias - Displays info on the simple_shell builtin command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - Displays information on the simple_shell builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays information on the simple_shell builtin command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Displays information on the simple_shell builtin command 'help'.
 */
void help_help(void)
{
